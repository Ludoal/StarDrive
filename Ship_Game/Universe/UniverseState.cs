...
namespace Ship_Game.Universe
{
    ...
    public sealed partial class UniverseState : IDisposable
    {
        ...
        // Ludoal fork: the pause the PLAYER set, as opposed to a page's automatic hold. A
        // manual pause survives the pages that open and close over it - releasing an
        // automatic claim never lifts it.
        ...
        [StarData] public bool ShowFoodRoutesOverlay;         // Ludoal fork (bench 428): one toggle per goods
        [StarData] public bool ShowProdRoutesOverlay;
        [StarData] public bool ShowPopRoutesOverlay;
        ...
        // ⚠ the full value is READ, never written: a mod that declares 6 gets 6 at Default, and
        // every notch is a fraction of that. Hard-coding a number here would serve one mod and lie
        // to the rest.
        public float RemnantDesignStr => GlobalStats.Defaults.RemnantDesignStrMultiplier
                                       * (P.RemnantStrength switch
                                       {
