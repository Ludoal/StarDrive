...
{
    /// <summary>
    /// Mirrors the token ids of game/Content/GameText.yaml. The generator that produced it
    /// is not in this repository: a new token is added here and in the yaml by hand, with
    /// the same id (the fork's own tokens live from 30000 up).
    /// </summary>
    public enum GameText
    {
        ...
        NgExcludedBy = 4906,
        /// <summary>Save Blueprint As...</summary>
        ...
        FuUnitWorlds = 30352,
        /// <summary>Serving Freighters:</summary>
        FuServingFreighters = 30357,
