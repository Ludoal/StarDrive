...
namespace Ship_Game
{
    public sealed class ShipListScreen : GameScreen
    {
            ...
            : base(parent, toPause: parent)
        {
            ...
            // Orders holds a 300px FLOOR (MinWidth): AutoSize sizes it to its content but never
            // below 300, and it is not foldable - so FitToWidth can't shave it either. A live order
            // that still outgrows 300 is truncated with an ellipsis, full text in the hover tooltip.
