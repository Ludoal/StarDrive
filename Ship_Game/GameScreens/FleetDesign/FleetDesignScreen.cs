...
namespace Ship_Game
{
    public sealed partial class FleetDesignScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            // Ludoal fork: the column is as tall as the ten slots it shows. 5 right: clears the
            // Patrol badge from the edge.
            RectF leftRect = new(client.X + ListPad + 5, listTop, leftW, FleetButtonsList.BarHeight);
            LeftMenu = leftRect;
