...
namespace Ship_Game
{
    public class RaceArchetypeListItem : ScrollListItem<RaceArchetypeListItem>
    {
        ...
        {
            // (bench 347) size off the ITEMS area (ItemsHousing), which already excludes the
            // scrollbar lane and the side padding - and take 0.8 of THAT, not of the whole list
            // width, so the portrait keeps clear of the slider.
