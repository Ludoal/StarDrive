...
namespace Ship_Game.Ships
{
    public partial class Ship
    {
        ...
        {
            // Ludoal fork: keep what the save file restored. The rebuild itself is necessary
            // (hangar arrays and the readonly Has* flags come from the modules, not the save).
